...
<?php
    ...
    $data = $sistem->tampil_jenisbantuan();
?>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Data Jenis Bantuan</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="pages-admin.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Jenis Bantuan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Input Data Jenis Bantuan</h4>
                                <h6 class="card-subtitle">Masukkan informasi lengkap data jenis bantuan yang ingin didaftarkan</h6>
                                <form class="form-horizontal form-material" name="add-jenisbantuan" method="POST" action="process/add_jenisbantuan.php">
                                    <!--
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0 pt-3">ID Jenis Bantuan</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control pl-0 form-control-line" name="IdJenisBantuan" required>
                                        </div>
                                    </div>
                                    -->
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0 pt-3">Nama Jenis Bantuan</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control pl-0 form-control-line" name="NamaJenisBantuan" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <a href="pages-admin.php" class="btn btn-danger text-white mr-2">Kembali</a>
                                            <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="add-jenisbantuan">
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Data Jenis Bantuan Terdaftar</h4>
                                <h6 class="card-subtitle">List data jenis bantuan yang telah terdaftar</h6>
                                <div class="table-responsive">
                                    <table class="table user-table">
                                        <thead>
                                            <tr class="table-info">     
                                                <th class="border-top-0">ID Jenis Bantuan</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $data['IdJenisBantuan']?></td>
                                                <td><?php echo $data['NamaJenisBantuan']?></td>
                                                <?php if($login == "Admin"){ ?>
                                                <td>
                                                  <!-- Modal -->
                                                    <div class="modal fade" id="takeID<?php echo $data['IdJenisBantuan']?>" tabindex="-1" role="dialog" aria-labelledby="takeID" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header pb-0">
                                                                    <h4 class="modal-title card-title text-info">Edit Jenis Bantuan</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form class="form-horizontal form-material" name="edit-jenisbantuan" method="POST" action="process/edit_jenisbantuan.php">
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">ID Jenis Bantuan </label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="IdJenisBantuan" required readonly value="<?php echo $data['IdJenisBantuan']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Nama Jenis Bantuan</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="NamaJenisBantuan" required value="<?php echo $data['NamaJenisBantuan']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group mb-0">
                                                                            <div class="col-sm-12 text-right">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                                <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="edit-jenisbantuan">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <!-- Modal -->
                                                    <button type="button" class="btn btn-warning text-white mb-1" data-toggle="modal" data-target="#takeID<?php echo $data['IdJenisBantuan']?>">Edit</button>
                                                    <a href="process/delete_jenisbantuan.php?id=<?php echo $data['IdJenisBantuan']?>" class="btn btn-danger text-white mb-1">Hapus</a>
                                                </td>
                                                <?php } ?>
                                            </tr>  
                                            <?php
                ...
                <!-- ============================================================== -->
                <!-- End Tabel Jenis Bantuan Terdaftar -->
                <!-- ============================================================== -->
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
