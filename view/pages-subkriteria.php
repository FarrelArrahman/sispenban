...
<?php
    ...
    $data = $sistem->tampil_subkriteria();
?>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Data Sub Kriteria</h3>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Input Data Sub Kriteria</h4>
                                <h6 class="card-subtitle">Masukkan informasi lengkap data sub kriteria yang ingin didaftarkan</h6>
                                <form class="form-horizontal form-material" name="add-subkriteria" method="POST" action="process/add_subkriteria.php">
                                   <div class="form-group">
                                        <label class="col-sm-4 mb-0"> Nama Kriteria </label>
                                        <div class="col-sm-4">
                                            <select class="form-control pl-0 form-control-line" name="IdDetailKriteria" required>
                                               <option value="" disabled selected>- Nama Kriteria -</option>
                                               <?php  
                                                    // $query=$this->conn->query("SELECT * FROM DataJenisBantuan");
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0 pt-3">Nama Sub Kriteria</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control pl-0 form-control-line" name="NamaSubKriteria" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 mb-0">Bobot Sub Kriteria</label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control pl-0 form-control-line" name="BobotSubKriteria" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <a href="pages-admin.php" class="btn btn-danger text-white mr-2">Kembali</a>
                                            <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="add-subkriteria">
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Data Sub Kriteria Terdaftar</h4>
                                <h6 class="card-subtitle">List data sub kriteria yang telah terdaftar</h6>
                                <div class="table-responsive">
                                    <table class="table user-table">
                                        <thead>
                                            <tr class="table-info">
                                                <th class="border-top-0">ID Kriteria</th>
                                                <th class="border-top-0">ID Sub Kriteria</th>
                                                <th class="border-top-0">Nama Kriteria</th>
                                                <th class="border-top-0">Nama Sub Kriteria</th>
                                                <th class="border-top-0">Bobot Sub Kriteria</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="takeID<?php echo $data['IdSubKriteria']?>" tabindex="-1" role="dialog" aria-labelledby="takeID" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header pb-0">
                                                                    <h4 class="modal-title card-title text-info">Edit Sub Kriteria</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form class="form-horizontal form-material" name="edit-subkriteria" method="POST" action="process/edit_subkriteria.php">
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">ID Sub Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="IdSubKriteria" required readonly value="<?php echo $data['IdSubKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <select class="form-control pl-0 form-control-line" name="IdKriteria" required>
                                                                                       <option value="" disabled>- Kriteria -</option>
                                                                                       <?php  
                                                                                            foreach($sistem->tampil_kriteria() as $kriteria){
                                                                                        ?>
                                                                                            <option <?php if($data['IdKriteria'] == $kriteria['IdKriteria']) echo 'selected' ?> value="<?= $kriteria['IdKriteria'] ?>"> <?php echo $kriteria['IdKriteria'] . ' - ' . $kriteria['NamaKriteria'] ?></option>
                                                                                        <?php } ?>
                                                                                   </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Nama Sub Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="NamaSubKriteria" required value="<?php echo $data['NamaSubKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Bobot Sub Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="BobotSubKriteria" required value="<?php echo $data['BobotSubKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group mb-0">
                                                                            <div class="col-sm-12 text-right">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                                <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="edit-subkriteria">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <!-- Modal -->
                                                    <button type="button" class="btn btn-warning text-white mb-1" data-toggle="modal" data-target="#takeID<?php echo $data['IdSubKriteria']?>">Edit</button>
                                                    <a href="process/delete_subkriteria.php?id=<?php echo $data['IdSubKriteria']?>" class="btn btn-danger text-white mb-1">Hapus</a>
                                                </td>
                                                <?php } ?>
                                            </tr>
                                            <?php
