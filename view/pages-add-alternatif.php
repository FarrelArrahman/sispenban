            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Input Data Alternatif</h4>
                                <h6 class="card-subtitle">Masukkan data alternatif yang ingin didaftarkan</h6>
                                <form class="form-horizontal form-material" name="add-alternatif" method="POST" action="process/add_alternatif.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-md-4 mb-0">NIK</label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control pl-0 form-control-line" name="NIK" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 mb-0">No. KK</label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control pl-0 form-control-line" name="NoKK" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Nama Kepala Keluarga</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control pl-0 form-control-line" name="Nama" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control pl-0 form-control-line" name="IdJenisBantuan" required>
                                               ...
                                               <?php  
                                                    ...
                                                    echo "<option value='$data[IdJenisBantuan]'> $data[NamaJenisBantuan] </option>";  
                                                    }
                                                ?>
                                           </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            ...
                                            <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="add-alternatif">
                                        </div>
                                    </div>
                                </form>
                            </div>
