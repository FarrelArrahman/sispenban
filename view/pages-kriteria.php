            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Input Data Kriteria</h4>
                                <h6 class="card-subtitle">Masukkan informasi lengkap data kriteria yang ingin didaftarkan</h6>
                                <form class="form-horizontal form-material" name="add-kriteria" method="POST" action="process/add_kriteria.php">
                                    
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0 pt-3">Nama Kriteria</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control pl-0 form-control-line" name="NamaKriteria" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 mb-0">Bobot Kriteria </label>
                                        <div class="col-md-4">
                                            <input type="number" class="form-control pl-0 form-control-line" name="BobotKriteria" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 mb-0">Jenis Kriteria</label>
                                        <div class="col-sm-4">
                                           <select class="form-control pl-0 form-control-line" name="JenisKriteria" required>
                                           <option value="" disabled selected>- Jenis Kriteria -</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            ...
                                            <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="add-kriteria">
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Data Kriteria Terdaftar</h4>
                                <h6 class="card-subtitle">List data kriteria yang telah terdaftar</h6>
                                    ...
                                    <table class="table user-table">
                                        <thead>
                                            <tr class="table-info">
                                                ...
                                                <th class="border-top-0">Bobot Kriteria</th>
                                                <th class="border-top-0">Jenis Kriteria</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['JenisKriteria']?></td>
                                                <?php if($login == "Admin"){ ?>
                                                <td>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="takeID<?php echo $data['IdKriteria']?>" tabindex="-1" role="dialog" aria-labelledby="takeID" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header pb-0">
                                                                    <h4 class="modal-title card-title text-info">Edit Nama Kriteria</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <form class="form-horizontal form-material" name="edit-kriteria" method="POST" action="process/edit_kriteria.php">
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">ID Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="IdKriteria" required readonly value="<?php echo $data['IdKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Nama Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="NamaKriteria" required value="<?php echo $data['NamaKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                         <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Bobot Kriteria</label>
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control pl-0 form-control-line" name="BobotKriteria" required value="<?php echo $data['BobotKriteria']?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="col-md-12 mb-0 text-dark font-weight-normal">Jenis Kriteria</label>
                                                                            <div class="col-md-12">
                                                                               <select class="form-control pl-0 form-control-line" name="JenisKriteria" required value="<?php echo $data['JenisKriteria']?>">
                                                                               <option value="" disabled selected>- Jenis Kriteria -</option>
                                                                               <option value="BENEFIT">BENEFIT</option>
                                                                               <option value="COST">COST</option>
                                                                               </select>
                                                                        ...
                                                                        <div class="form-group mb-0">
                                                                            <div class="col-sm-12 text-right">
                                                                                ...
                                                                                <input type="submit" class="btn btn-success mx-auto mx-md-0 text-white" value="Simpan" name="edit-kriteria">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <!-- Modal -->
                                                    <button type="button" class="btn btn-warning text-white mb-1" data-toggle="modal" data-target="#takeID<?php echo $data['IdKriteria']?>">Edit</button>
                                                    <a href="process/delete_kriteria.php?id=<?php echo $data['IdKriteria']?>" class="btn btn-danger text-white mb-1">Hapus</a>
                                                </td>
                                                <?php } ?>
                                            </tr>
                                            <?php
