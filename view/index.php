                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin6">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="../assets/images/users/person.png" alt="user" class="profile-pic m-r-10"> Selamat Datang Penduduk
                                <?php
                                echo $login;
                            ?>
                            </a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <!-- ============================================================== -->
                        <!-- <li class="nav-item dropdown"> -->
                            <!-- <a class="btn btn-light text-dark waves-effect waves-dark mr-4" href="process/logout.php"><i class="mdi mr-2 mdi-logout"></i><span class="hide-menu">Logout</span></a> -->
                        <!-- </li> -->
                    </ul>
                </div>
            </nav>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Data Keluarga Miskin</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Keluarga Miskin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-right upgrade-btn search-box">
                            <a href="javascript:void(0)" class="btn btn-danger d-none d-md-inline-block text-white"><i class="mdi mr-2 mdi-account-convert"></i><span class="hide-menu">Cari Keluarga Miskin</span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-info">Keluarga Miskin Terdaftar</h4>
                                <h6 class="card-subtitle">List data seluruh keluarga miskin yang telah terdaftar</h6>
